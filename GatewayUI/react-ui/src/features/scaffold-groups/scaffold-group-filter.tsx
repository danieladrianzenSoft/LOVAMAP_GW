...
const ScaffoldGroupFilters: React.FC<ScaffoldGroupFiltersProps> = ({ condensed = false, setIsLoading }) => {
    ...
    const [filtersVisible, setFiltersVisible] = useState<boolean>(!condensed);
