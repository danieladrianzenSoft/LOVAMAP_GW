...
export const ExploreData: React.FC = observer(() => {
	const { commonStore, scaffoldGroupStore, resourceStore } = useStore();
			...
			<div className="container pr-2">
				...
				<div className="mb-2">
					<p className="text-sm md:text-base text-gray-700 mt-1 py-2">
						<span>
							Look to the right 👉🏽 those are the scaffolds. Add more to the plots by searching below.
						</span>
						<br />
						<span>
							Zoom into plots by dragging. Double click to reset.

						</span>
					</p>
				</div>

				<div className="mb-4 mt-0 mr-2 relative" ref={searchContainerRef}>
					<AISearchBar
						onSearch={runSearch}
				...
				{!isLoading && Object.entries(groupedDescriptorsBySection).map(([sectionTitle, descriptors]) => (
					<div key={sectionTitle}>
						<h3 className="text-xl font-semibold text-gray-600 mb-4 mt-0 pt-4">{sectionTitle}</h3>
