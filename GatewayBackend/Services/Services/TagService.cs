...
{	public class TagService : ITagService
	{
		...
		public async Task SeedTags(IEnumerable<TagToSeedDto> tagsToCreate)
		{
			try
			{
				var tags = tagsToCreate.Select(dto => _modelMapper.MapToTag(dto)).ToList();
		...
		{
			return await _tagRepository.GetTagsByIds(ids);
		}

		public async Task<List<int>> GetAutogeneratedTagIdsFromNames(ICollection<string> tagNames)
		{
			return await _tagRepository.GetAutogeneratedTagIdsFromNames(tagNames);
		}
