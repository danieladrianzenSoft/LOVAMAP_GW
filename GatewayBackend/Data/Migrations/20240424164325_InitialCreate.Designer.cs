...
namespace Data.Migrations
{
    ...
    [Migration("20240424164325_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.Experiment", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Data.Models.Thumbnail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Data.Models.Experiment", b =>
                {
                    b.HasOne("Data.Models.InputGroup", "InputGroup")
                        .WithOne("Experiment")
                        .HasForeignKey("Data.Models.Experiment", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data.Models.Scaffold", b =>
                {
                    b.HasOne("Data.Models.Experiment", "Experiment")
                        .WithMany("Scaffolds")
            ...
            modelBuilder.Entity("Data.Models.Thumbnail", b =>
                {
                    b.HasOne("Data.Models.Experiment", "Experiment")
                        .WithOne("Thumbnail")
                        .HasForeignKey("Data.Models.Thumbnail", "ExperimentId")
                        .OnDelete(DeleteBehavior.Cascade);
