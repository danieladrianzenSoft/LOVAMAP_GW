...
namespace Data.Data.Migrations
{
    ...
    [Migration("20240501151940_AddedDispersityToParticlePropertyGroup")]
    partial class AddedDispersityToParticlePropertyGroup
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Data.Models.Thumbnail", b =>
                {
                    b.HasOne("Data.Models.ScaffoldGroup", "ScaffoldGroup")
                        .WithOne("Thumbnail")
                        .HasForeignKey("Data.Models.Thumbnail", "ScaffoldGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
